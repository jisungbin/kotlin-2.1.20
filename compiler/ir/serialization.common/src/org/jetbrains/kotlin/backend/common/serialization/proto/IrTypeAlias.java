...
public final class IrTypeAlias extends
    ...
    public static Parser<IrTypeAlias> PARSER =
            new AbstractParser<IrTypeAlias>() {
                @Override
    ...
    private IrTypeAlias(boolean noInit) {
    ...
    public static IrTypeAlias parseFrom(InputStream input)
            throws IOException {
    ...
    public static IrTypeAlias parseDelimitedFrom(InputStream input)
            throws IOException {
