...
public final class IrComposite extends
    ...
    public static Parser<IrComposite> PARSER =
            new AbstractParser<IrComposite>() {
                @Override
    ...
    private IrComposite(boolean noInit) {
    ...
    public static IrComposite parseFrom(InputStream input)
            throws IOException {
    ...
    public static IrComposite parseDelimitedFrom(InputStream input)
            throws IOException {
