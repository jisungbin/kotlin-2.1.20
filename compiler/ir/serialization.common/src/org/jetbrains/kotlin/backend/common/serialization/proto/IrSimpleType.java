...
public final class IrSimpleType extends
    ...
    public static Parser<IrSimpleType> PARSER =
            new AbstractParser<IrSimpleType>() {
                @Override
    ...
    private IrSimpleType(boolean noInit) {
    ...
    public static IrSimpleType parseFrom(InputStream input)
            throws IOException {
    ...
    public static IrSimpleType parseDelimitedFrom(InputStream input)
            throws IOException {
