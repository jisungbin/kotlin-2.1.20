...
public final class IrCall extends
    ...
    public static Parser<IrCall> PARSER =
            new AbstractParser<IrCall>() {
                @Override
    ...
    public static IrCall parseFrom(InputStream input)
            throws IOException {
    ...
    public static IrCall parseDelimitedFrom(InputStream input)
            throws IOException {
