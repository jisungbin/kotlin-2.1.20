...
public final class IrField extends
    ...
    public static Parser<IrField> PARSER =
            new AbstractParser<IrField>() {
                @Override
    ...
    private IrField(boolean noInit) {
    ...
    public static IrField parseFrom(InputStream input)
            throws IOException {
    ...
    public static IrField parseDelimitedFrom(InputStream input)
            throws IOException {
