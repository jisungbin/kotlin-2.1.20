...
import org.jetbrains.kotlin.backend.jvm.addSetterStatements
import org.jetbrains.kotlin.backend.jvm.collectPropertiesOrFieldsAfterLowering
import org.jetbrains.kotlin.backend.jvm.createInstanceFromBox
import org.jetbrains.kotlin.backend.jvm.createInstanceFromValueDeclarationsAndBoxType
import org.jetbrains.kotlin.backend.jvm.fields
import org.jetbrains.kotlin.backend.jvm.fullFieldName
import org.jetbrains.kotlin.backend.jvm.ir.createJvmIrBuilder
import org.jetbrains.kotlin.backend.jvm.isKotlinExternalStub
import org.jetbrains.kotlin.backend.jvm.isRepeatableGetter
import org.jetbrains.kotlin.backend.jvm.localClassType
import org.jetbrains.kotlin.backend.jvm.lower.BlockOrBody.Block
import org.jetbrains.kotlin.backend.jvm.makeSetterExpressions
import org.jetbrains.kotlin.backend.jvm.makeTypeArgumentsFromType
import org.jetbrains.kotlin.backend.jvm.mapLeaves
import org.jetbrains.kotlin.backend.jvm.name
import org.jetbrains.kotlin.backend.jvm.needsMfvcFlattening
import org.jetbrains.kotlin.backend.jvm.oldMfvcDefaultArgument
import org.jetbrains.kotlin.backend.jvm.parameterTemplateStructureOfThisNewMfvcBidingFunction
import org.jetbrains.kotlin.backend.jvm.parameterTemplateStructureOfThisOldMfvcBidingFunction
import org.jetbrains.kotlin.backend.jvm.savableStandaloneVariable
import org.jetbrains.kotlin.backend.jvm.savableStandaloneVariableWithSetter
import org.jetbrains.kotlin.backend.jvm.size
import org.jetbrains.kotlin.backend.jvm.throwWhenNotExternalIsNull
