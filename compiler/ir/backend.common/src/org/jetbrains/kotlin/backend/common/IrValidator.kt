...
import org.jetbrains.kotlin.backend.common.checkers.declaration.IrFieldChecker
import org.jetbrains.kotlin.backend.common.checkers.declaration.IrFieldVisibilityChecker
import org.jetbrains.kotlin.backend.common.checkers.declaration.IrFunctionChecker
...
import org.jetbrains.kotlin.backend.common.checkers.declaration.IrValueParameterChecker
import org.jetbrains.kotlin.backend.common.checkers.declaration.IrValueParameterVarargTypesChecker
import org.jetbrains.kotlin.backend.common.checkers.declaration.check
import org.jetbrains.kotlin.backend.common.checkers.expression.IrBreakContinueChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrCallBoundChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrCallChecker
...
import org.jetbrains.kotlin.backend.common.checkers.expression.IrConstChecker
...
import org.jetbrains.kotlin.backend.common.checkers.expression.IrDeclarationReferenceBoundChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrDeclarationReferenceChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrDeclarationReferenceVisibilityChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrDelegatingConstructorCallChecker
...
import org.jetbrains.kotlin.backend.common.checkers.expression.IrFieldAccessChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrFunctionAccessChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrFunctionReferenceChecker
...
import org.jetbrains.kotlin.backend.common.checkers.expression.IrGetFieldChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrGetFieldTypeChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrGetObjectValueChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrGetObjectValueTypeChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrGetValueChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrGetValueTypeChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrInstanceInitializerCallBoundChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrInstanceInitializerCallChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrLocalDelegatedPropertyReferenceBoundChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrLocalDelegatedPropertyReferenceChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrLoopChecker
...
import org.jetbrains.kotlin.backend.common.checkers.expression.IrPropertyReferenceBoundChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrPropertyReferenceChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrReturnBoundChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrReturnChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrSetFieldChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrSetValueAssignabilityChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrSetValueChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrStringConcatenationChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrStringConcatenationTypeChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrThrowChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrTypeOperatorChecker
...
import org.jetbrains.kotlin.backend.common.checkers.expression.IrValueAccessChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrValueAccessScopeChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrVarargChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.IrVarargTypesChecker
import org.jetbrains.kotlin.backend.common.checkers.expression.check
