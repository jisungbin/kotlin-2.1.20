...
import org.jetbrains.kotlin.ir.util.IdSignatureRenderer.Companion.DEFAULT
import org.jetbrains.kotlin.ir.util.IdSignatureRenderer.Companion.LEGACY


fun IdSignature.render(renderer: IdSignatureRenderer = DEFAULT): String = renderer.render(this)
